...
| HTTP layer (admin / health / metrics) | FastAPI | 0.115.6 (D-049) | Mounted as a separate process (`api/`). Sprint 10 ships health/ready/metrics only; admin endpoints (8.3) remain deferred. |
