...
| HTTP layer (admin / health / metrics) | FastAPI | 0.115.6 (D-049) | Mounted as a separate process (`api/`). Sprint 10 shipped health/ready/metrics; the `/v1/admin/*` surface (Task 8.3) was added 2026-06-25, gated by `ADMIN_API_KEY` (D-051). |
...
> **Status: IN PROGRESS (Sprint 9.6, EP-22).** Built and committed: signed `P|` callback
...
> **Status: IN PROGRESS (Sprint 9.6, EP-23).** Realized as part of F-2's compose wizard
