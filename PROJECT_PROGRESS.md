...
| **Total** |  |  | **90%** | **95 / 105** | Row sum above is 93; **+2** from Owner-feedback hardening rounds #14–#31 (not broken out as their own row, longstanding convention). Excludes decimal sub-sprints 9.5 (10/10) and 11.5 (12/12) — tracked separately, per precedent. |
